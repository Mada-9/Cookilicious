...
const PageRecetteDashboard = () => {
  ...
  return (
    <div className="container-fluid px-2 px-md-5 py-4">
      <h2 className="dashboardHeader text-center mb-5 ps-lg-4">
                  ...
                  <tr key={item._id}>
                    ...
                    <td>
                      <div className="d-flex justify-content-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            navigate(`/admin/recettedetail/${item._id}`)
                          }
                          className="btn btn-sm btn-outline-secondary"
                        >
                        ...
                        <button
                          onClick={() =>
                            navigate(`/admin/updaterecette/${item._id}`)
                          }
                          className="btn btn-sm btn-outline-secondary"
                        >
              ...
              >
                ...
                >
                  ...
                  <div className="d-flex justify-content-between border-top pt-3 mt-2">
                    <button
                      onClick={() => toggleStatus(item._id, item.isActive)}
                      className="btn  btn-sm flex-grow-1 me-2 border"
                      style={{ color: "var(--marronRouge)" }}
                    >
