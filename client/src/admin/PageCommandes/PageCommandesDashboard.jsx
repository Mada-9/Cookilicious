            ...
            <table className="table align-middle mb-0">
              ...
              <tbody>
                {commande.map((item, index) => (
                  <tr key={item._id}>
                    <td className="px-4 tdTable text-muted">{index + 1}</td>
                    <td className="tdTable small">
                      {item._id.substring(0, 8)}...
                    </td>
                   
                    <td className="tdTable text-marron">{item.prixTotal} €</td>
              ...
              >
                <div className="card-body p-3" style={{color:"var(--marronRouge)"}}>
                  ...
                  <div className="mb-3">
                    ...
                    <p className="mb-0">
                      <strong>Total:</strong> {item.prixTotal}
                    </p>
                  </div>
                  ...
                  <div className="d-flex justify-content-between border-top pt-3 gap-2">
                    <button
                      ...
                      className="btn btn-sm flex-grow-1 border" style={{color:"var(--marronRouge)"}}
                    >
